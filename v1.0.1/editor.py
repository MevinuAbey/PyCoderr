...
class PyCoderr:
    def __init__(self, root):
        self.root = root
        self.root.title("PyCoderr - V1")
        self.root.geometry("950x650")
        self.filename = None
        self.default_font = ("Consolas", 13)

        # Dark Theme Colors
        self.bg_color = "#11111B"
        self.text_bg = "#1E1E2E"
        self.text_fg = "#ffffff"
        self.linenumber_bg = "#11111B"
        self.linenumber_fg = "#858585"
        self.btn_bg = "#2F2F4A"
        self.btn_fg = "#ffffff"
        self.btn_hover_bg = "#1177bb"
        self.status_bg = "#11111B"
    ...
    def create_widgets(self):
        ...
        self.font_btn = self.make_button(top_frame, "Settings", self.set_font)
    ...
    # ------------------------------
    # Font Settings (remnamed and improved to Settinf from v1.1)
    # ------------------------------
    def set_font(self):
        font_win = tk.Toplevel(self.root)
        font_win.title("Settings")
        font_win.geometry("250x130")
        ...
        tk.Button(font_win, text="Apply", bg=self.btn_bg, fg=self.btn_fg, command=apply_font).grid(row=3, column=0, columnspan=2, pady=10)
    ...
    def show_about(self):
        ...
        frame = tk.Frame(about_win, bg="#1E1E2E", padx=15, pady=15)
        frame.pack(fill=tk.BOTH, expand=True, padx=10, pady=10)

        title = tk.Label(frame, text="PyCoderr", font=("Segoe UI", 20, "bold"), bg="#1E1E2E", fg="#00c8ff")
        ...
        label = tk.Label(frame, text=text, bg="#1E1E2E", fg="#FFFFFF",
